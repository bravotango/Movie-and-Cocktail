...
This application allows users to search movies for a synopsis; including a description, genre, and runtime. Based on the movie genre, recommended cocktails are presented in a carousel. Clicking a cocktail from the carousel will take the user to ingredients and instructions on how to mix the chosen cocktail.
